...
namespace APISsaludAnimalClnicaVeterinatia.Data
{
    public class ConexionBD
    {
        ...
        private bool AbrirConexion()
        {
            try
            {
                //workstation id=saludAnimalVeterinaria00.mssql.somee.com;packet size=4096;user id=AndresFj_SQLLogin_1;pwd=8z5gv7ik19;data source=saludAnimalVeterinaria00.mssql.somee.com;persist security info=False;initial catalog=saludAnimalVeterinaria00;TrustServerCertificate=True
                //"workstation id=saludAnimalVeterinaria00.mssql.somee.com;packet size=4096;user id=AndresFj_SQLLogin_1;pwd=8z5gv7ik19;data source=saludAnimalVeterinaria00.mssql.somee.com;persist security info=False;initial catalog=saludAnimalVeterinaria00;TrustServerCertificate=True"
                strCadenaCnx = "workstation id=saludAnimalVeterinaria00.mssql.somee.com;packet size=4096;user id=AndresFj_SQLLogin_1;pwd=8z5gv7ik19;data source=saludAnimalVeterinaria00.mssql.somee.com;persist security info=False;initial catalog=saludAnimalVeterinaria00;TrustServerCertificate=True";
        ...
        public bool EjecutarSentencia(string SentenciaSQL, bool blnCon_Parametros)
        {
            ...
            catch (Exception ex)
            {
                ...
                System.Diagnostics.Debug.WriteLine("edward" + strError);
